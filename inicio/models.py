...
class Huerto(models.Model):
    IDHuerto = models.UUIDField(
        primary_key=True, default=uuid.uuid4, editable=False, unique=True)
    numero_hectareas = models.DecimalField(
    ...
    Productor = models.ForeignKey(
        'Productor', on_delete=models.CASCADE, unique=False, null=False, blank=False)


class ProductoCampo(models.Model):
    IDProductoCampo = models.UUIDField(
        primary_key=True, default=uuid.uuid4, editable=False, unique=True)
    calidad_aprox = EnumField(
        choices=[('e', 'Excelente'), ('b', 'Buena'), ('r', 'Regular'), ('m', 'Mala')])
    ...
    Empleado = models.ForeignKey(
        'Empleado', on_delete=models.CASCADE, unique=False, null=False, blank=False)
    Productor = models.ForeignKey(
        'Productor', on_delete=models.CASCADE, unique=False, null=False, blank=False)
...
class Status_pc(models.Model):
    ...
    estado = EnumField(choices=[
                       ('p', 'Pendiente'), ('r', 'Reposo'), ('c', 'Completada'), ('a', 'Pagada')])
    IDProductoCampo = models.ForeignKey(
        'ProductoCampo', on_delete=models.CASCADE, unique=False, null=False, blank=False)


class Producto(models.Model):
    IDProducto = models.UUIDField(
        primary_key=True, default=uuid.uuid4, editable=False, unique=True)
    nombre = models.CharField(max_length=100, blank=True)
...
class ProductoCorrida(models.Model):
    ...
    calibre = models.CharField(max_length=100, blank=False, null=False, choices=[
                               ("pruebs", "prueba"), ("prueba1", "prueba")])
    ...
    ProductoCampo = models.ForeignKey(
        'ProductoCampo', on_delete=models.CASCADE, unique=False, null=False, blank=False)
    Detalle = models.ForeignKey(
        'Detalle', on_delete=models.CASCADE, unique=False, null=True, blank=True)
...
class Precio(models.Model):
    ...
    preciokg = models.DecimalField(
        max_digits=10, decimal_places=3, default=0, blank=False, null=False)
    tipo = EnumField(choices=[('c', 'Compra'), ('v', 'Venta')])
    ProductoCorrida = models.ForeignKey(
        'ProductoCorrida', on_delete=models.CASCADE, unique=False, null=False, blank=False)
    Empleado = models.ForeignKey(
        'Empleado', on_delete=models.CASCADE, unique=False, null=False, blank=False)
...
class Caja(models.Model):
    ...
    tamanio = EnumField(
        choices=[('c', 'Chico'), ('m', 'Mediano'), ('g', 'Grande')])
    alto = models.DecimalField(
        max_digits=10, decimal_places=3, default=0, blank=False)
...
class Prueba(models.Model):
    IDPrueba = models.UUIDField(
        primary_key=True, default=uuid.uuid4, editable=False, unique=True)
    kilogramos = models.DecimalField(
        max_digits=10, decimal_places=3, default=0, blank=False)
    Caja = models.ForeignKey(
        'Caja', on_delete=models.CASCADE, unique=False, null=False, blank=False)
...
class Detalle(models.Model):
    ...
    OrdenCompra = models.ForeignKey(
        'OrdenCompra', on_delete=models.CASCADE, unique=False, null=False, blank=False)
...
class OrdenCompra(models.Model):
    ...
    Cliente = models.ForeignKey(
        'Cliente', on_delete=models.CASCADE, unique=False, null=False, blank=False)


class Cliente(models.Model):
    IDCliente = models.UUIDField(
        primary_key=True, default=uuid.uuid4, editable=False, unique=True)
    nombre = models.CharField(max_length=100, blank=True)
    apellido_paterno = models.CharField(max_length=100, blank=True)
    apellido_materno = models.CharField(max_length=100, blank=True)
